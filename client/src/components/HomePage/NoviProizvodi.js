...
function NoviProizvodi() {
	...
	const loadProducts = async () => {
		await newProduct('createdAt', 'desc', page)
			.then((res) => {
				setLoading(true);
	...
	return (
		<div>
			...
			<div className="row">
				<div className="col-md-5 text-center ml-auto mr-auto mt-4">
					<Pagination
						defaultCurrent={page}
