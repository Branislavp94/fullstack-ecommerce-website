...
const SubCreate = () => {
	...
	const handleSubmit = async (e) => {
		e.preventDefault();
		setLoading(true);
		await createSub({ name, parent: parent.parent }, user.token)
			.then((res) => {
				setLoading(false);
				setName('');
			...
			<div className="row">
				...
				<div className="col">
					...
					<div className="form-group">
						...
						<select className="form-control" onChange={handleSubCategoryChanges} name="parent">
					...
					{CategorySubs.filter(searched(keyword)).map((s) => (
